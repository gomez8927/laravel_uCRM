                      ...
                      <div class="p-2 w-full">
                        <div class="flex items-center">
                          ...
                          <div class="ml-4 flex space-x-4">
                            <div class="flex items-center">
                              <input type="radio" id="is_selling_1" name="is_selling" v-model="form.is_selling" :value="1">
                              <label for="is_selling_1" class="text-sm text-gray-600 ml-2">販売中</label>
                            </div>
                            <div class="flex items-center">
                              <input type="radio" id="is_selling_0" name="is_selling" v-model="form.is_selling" :value="0">
                              <label for="is_selling_0" class="text-sm text-gray-600 ml-2">停止中</label>
                            </div>
                          </div>
                        </div>
                      </div>
